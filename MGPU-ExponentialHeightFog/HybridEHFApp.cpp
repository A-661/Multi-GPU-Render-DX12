...
HybridEHFApp::HybridEHFApp(const HINSTANCE hInstance) : D3DApp(hInstance), debugLogger(FileQueueWriter(std::filesystem::current_path() / "log.txt"))
{
    mSceneBounds.Center = Vector3(0.0f, 0.0f, 0.0f);
    mSceneBounds.Radius = 200;
}

HybridEHFApp::~HybridEHFApp() = default;

void HybridEHFApp::SwitchDevice()
{
    Flush();
    IsUsingSharedSSAO = !IsUsingSharedSSAO;
}

void HybridEHFApp::ChangeAOMethod()
{
    Flush();
    IsUseHBAO = !IsUseHBAO;
}
...
void HybridEHFApp::Update(const GameTimer& gt)
{
...
void HybridEHFApp::PopulateShadowMapCommands(const std::shared_ptr<GCommandList>& cmdList)
{
...
void HybridEHFApp::PopulateNormalMapCommands(const std::shared_ptr<GCommandList>& cmdList)
{
    //Draw Normals
    {
...
void HybridEHFApp::PopulateAmbientMapCommands(const std::shared_ptr<GCommandList>& cmdList) const
{
...
void HybridEHFApp::PopulateFogMapCommands(const std::shared_ptr<GCommandList>& cmdList) const
{
    if (!IsUseFog)
    {
        return;
...
void HybridEHFApp::PopulateForwardPathCommands(const std::shared_ptr<GCommandList>& cmdList)
{
...
void HybridEHFApp::PopulateDrawCommands(const std::shared_ptr<GCommandList>& cmdList,
...
void HybridEHFApp::PopulateInitRenderTarget(const std::shared_ptr<GCommandList>& cmdList, const GTexture& renderTarget,
...
void HybridEHFApp::PopulateDrawFullQuadTexture(const std::shared_ptr<GCommandList>& cmdList,
...
void HybridEHFApp::PopulateDebugCommands(const std::shared_ptr<GCommandList>& cmdList)
{
    switch (pathMapShow)
    {
    case 1:
...
void HybridEHFApp::Draw(const GameTimer& gt)
{
...
void HybridEHFApp::InitFrameResource()
{
...
void HybridEHFApp::InitRootSignature()
{
...
void HybridEHFApp::InitPipeLineResource()
{
    defaultInputLayout =
    {
        {
...
void HybridEHFApp::CreateMaterials()
{
...
void HybridEHFApp::InitSRVMemoryAndMaterials()
{
    srvTexturesMemory =
...
void HybridEHFApp::InitRenderPaths()
{
...
void HybridEHFApp::LoadStudyTexture()
{
...
void HybridEHFApp::MipMasGenerate()
{
    try
    {
        {
...
void HybridEHFApp::OnApplicationExit()
{
    debugLogger.WriteAllLog();
}

int HybridEHFApp::Run()
{
    MSG msg = {nullptr};
...
void HybridEHFApp::UpdateMaterials() const
{
    {
...
void HybridEHFApp::UpdateShadowTransform(const GameTimer& gt)
{
...
void HybridEHFApp::UpdateShadowPassCB(const GameTimer& gt)
{
...
void HybridEHFApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void HybridEHFApp::UpdateSsaoCB(const GameTimer& gt) const
{
...
void HybridEHFApp::UpdateFogCB(const GameTimer& gt) const
{
    (void)gt;
...
bool HybridEHFApp::InitMainWindow()
{
...
void HybridEHFApp::Flush()
{
    primeDevice->Flush();
    secondDevice->Flush();
}

LRESULT HybridEHFApp::MsgProc(const HWND hwnd, const UINT msg, const WPARAM wParam, const LPARAM lParam)
{
